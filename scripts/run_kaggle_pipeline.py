...
try:
    ...
    print("Downgrading PyTorch to 2.2.2 for Tesla P100 (sm_60) compatibility on Python 3.12...")
    subprocess.run("pip install torch==2.2.2 torchvision==0.17.2 torchaudio==2.2.2 --index-url https://download.pytorch.org/whl/cu118", shell=True, check=True)
