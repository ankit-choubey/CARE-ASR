...
def generate_mock_afrispeech_data() -> list[ASRTranscriptInput]:
    ...
    return [
        ASRTranscriptInput(
            ...
            words=[
                WordAlignment(word="Patient", start_time=0.0, end_time=0.5, confidence=1.0, entropy=0.0, start_char=0, end_char=7),
                WordAlignment(word="prescribed", start_time=0.6, end_time=1.0, confidence=1.0, entropy=0.0, start_char=8, end_char=18),
                WordAlignment(word="metformin", start_time=1.1, end_time=1.6, confidence=1.0, entropy=0.0, start_char=19, end_char=28),
                WordAlignment(word="500mg", start_time=1.7, end_time=2.2, confidence=1.0, entropy=0.0, start_char=29, end_char=34),
                WordAlignment(word="daily", start_time=2.3, end_time=2.7, confidence=1.0, entropy=0.0, start_char=35, end_char=40),
                WordAlignment(word="for", start_time=2.8, end_time=3.0, confidence=1.0, entropy=0.0, start_char=41, end_char=44),
                WordAlignment(word="diabetes.", start_time=3.1, end_time=3.8, confidence=1.0, entropy=0.0, start_char=45, end_char=54),
            ]
        )
    ]
