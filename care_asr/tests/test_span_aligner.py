...
def test_span_aligner_single_word_exact_match(sample_asr_input):
    aligner = SpanAligner()
    entities = [{"entity_text": "Aspirin", "category": "MED", "start_char": 14, "end_char": 21}]
...
def test_span_aligner_partial_overlap(sample_asr_input):
    ...
    entities = [{"entity_text": "hyper", "category": "COND", "start_char": 37, "end_char": 42}]
...
def test_span_aligner_empty_alignment():
    ...
    entities = [{"entity_text": "Ghost", "category": "COND", "start_char": 0, "end_char": 5}]
